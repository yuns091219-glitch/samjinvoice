        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2.5 sm:gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5 sm:space-x-3">
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl bg-[#5F7161] flex items-center justify-center text-white font-bold text-base sm:text-xl shadow-xs shrink-0">
                삼진
              </div>
              <div>
